					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +8801234569875</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> info@virtualshopping.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{ url('./')}}"><span style="font-size: 20px; color: orange; font-weight: bold;">Virtual</span><span style="font-size: 20px; color: #000; font-weight: bold;">Shopping</span></a>
						</div>
